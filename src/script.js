...
const parameters = {}
parameters.count = 225800
parameters.size = 0.001
parameters.radius = 9.47
parameters.branches = 7
parameters.spin = 1
parameters.randomness = 0.2
parameters.randomnessPower = 4.4
...
{
    /**
     * Destroy previous galaxies so that when we modify values, we don't make a ton and never delete them
     */
...
gui.add(parameters,'size').min(.001).max(.2).step(.001).onFinishChange(generateGalaxy)
